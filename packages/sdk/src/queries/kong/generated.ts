...
export type kong_GetVaultDataQuery = {
  vaults?: Array<{
    address?: string | null
    symbol?: string | null
    name?: string | null
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetVaultData(
      variables?: kong_GetVaultDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<kong_GetVaultDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<kong_GetVaultDataQuery>(GetVaultDataDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetVaultData',
